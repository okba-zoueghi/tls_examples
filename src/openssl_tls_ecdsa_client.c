...
#define CHAIN_OF_TRUST_CERT       "../certificates/ca.cert.ecdsa.pem"
#define CERTIFICATE_FILE_PATH     "../certificates/client.chain.cert.ecdsa.pem"
#define PRIVATE_KEY_FILE_PATH     "../keys/client.key.ecdsa.pem"
...
int main(int argc, char const *argv[]) {
    ...
    LOG_INFO("TLS max version set to v1.2");


    if (!SSL_CTX_set_cipher_list(ctx,TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256 ":"
